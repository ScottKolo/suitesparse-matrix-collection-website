class MatricesController < ApplicationController
  ...
  def matrix_params
    params.require(:matrix).permit(:submitter_name, :submitter_email, :submitter_confidentiality, :display_email, :name, :author, :notes, :author, :editor, :kind, :matrix_data_file_file_name)
  end
