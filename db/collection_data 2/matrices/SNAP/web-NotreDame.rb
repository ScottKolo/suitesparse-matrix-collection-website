{
    ...
    num_strongly_connected_components: '203609',
    pattern_symmetry: '0.517',
    numeric_symmetry: '0.517',
    rb_type: 'binary',
...
',
    image_files: 'web-NotreDame.png,web-NotreDame_APlusAT_graph.gif,web-NotreDame_graph.gif,',
}
