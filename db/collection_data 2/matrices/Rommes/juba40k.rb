{
    ...
    name: 'juba40k',
    group: 'Rommes',
    description: 'Brazilian Interconnect Power System Juba (CEPEL, Brazil)',
    author: 'N. Martins',
    editor: 'J. Rommes',
    date: '2010',
    ...
    num_strongly_connected_components: '4931',
    num_dmperm_blocks: '12954',
    structural_full_rank: 'false',
    structural_rank: '40335',
...
',
    aux_fields: 'B: sparse 40337-by-2
C: sparse 1-by-40337
E: sparse 40337-by-40337
iv: sparse 40337-by-1
',    image_files: 'juba40k.png,juba40k_dmperm.png,juba40k_scc.png,juba40k_APlusAT_graph.gif,juba40k_graph.gif,',
}
