...
',
    aux_fields: 'coord: full 252-by-2
',    norm: '3.917029e+00',
    min_singular_value: '1.160509e-16',
    condition_number: '33752678028859300',
    svd_rank: '250',
    sprank_minus_rank: '2',
    null_space_dimension: '2',
    full_numerical_rank: 'no',
    svd_gap: '55305030858968.218750',
    image_files: 'grid1.png,grid1_dmperm.png,grid1_dual.png,grid1_dual_dmperm.png,grid1_dual_gplot.png,grid1_dual_svd.png,grid1_gplot.png,grid1_svd.png,grid1_dual_graph.gif,grid1_graph.gif,',
}
