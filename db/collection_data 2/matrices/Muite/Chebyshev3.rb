...
',
    norm: '2.017564e+06',
    min_singular_value: '3.337566e-12',
    condition_number: '604501749475512832',
    svd_rank: '4099',
    sprank_minus_rank: '2',
    null_space_dimension: '2',
    full_numerical_rank: 'no',
    svd_gap: '168166.013471',
    image_files: 'Chebyshev3.png,Chebyshev3_svd.png,Chebyshev3_APlusAT_graph.gif,Chebyshev3_graph.gif,',
}
