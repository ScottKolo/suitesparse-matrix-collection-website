{
    ...
    group: 'DIMACS10',
    description: 'DIMACS10 set: kronecker/kron_g500-logn21',
    ...
    num_strongly_connected_components: '553159',
...
%% of the graph with edges from ij.                                     
  ...
  G = spones (G + G.\');                                                 
',
    image_files: 'kron_g500-logn21.png,kron_g500-logn21_scc.png,kron_g500-logn21_graph.gif,',
}
