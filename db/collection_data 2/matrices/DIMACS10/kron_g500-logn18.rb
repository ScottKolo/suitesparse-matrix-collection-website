{
    matrix_id: '2491',
    name: 'kron_g500-logn18',
    group: 'DIMACS10',
    description: 'DIMACS10 set: kronecker/kron_g500-logn18',
    ...
    num_strongly_connected_components: '51997',
...
%% of the graph with edges from ij.                                     
  ...
  G = spones (G + G.\');                                                 
',
    image_files: 'kron_g500-logn18.png,kron_g500-logn18_scc.png,kron_g500-logn18_graph.gif,',
}
