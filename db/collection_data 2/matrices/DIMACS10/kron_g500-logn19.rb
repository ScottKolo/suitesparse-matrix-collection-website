{
    matrix_id: '2492',
    name: 'kron_g500-logn19',
    group: 'DIMACS10',
    description: 'DIMACS10 set: kronecker/kron_g500-logn19',
    ...
    num_strongly_connected_components: '115140',
...
%% of the graph with edges from ij.                                     
  ...
  G = spones (G + G.\');                                                 
',
    image_files: 'kron_g500-logn19.png,kron_g500-logn19_scc.png,kron_g500-logn19_graph.gif,',
}
