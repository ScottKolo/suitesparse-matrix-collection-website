{
    matrix_id: '2646',
    name: 'vsp_vibrobox_scagr7-2c_rlfddd',
    group: 'DIMACS10',
    description: 'DIMACS10 set: star-mixtures/vsp_vibrobox_scagr7-2c_rlfddd',
    author: 'C. Schultz',
    editor: 'H. Meyerhenke',
    date: '2011',
...
',
    image_files: 'vsp_vibrobox_scagr7-2c_rlfddd.png,vsp_vibrobox_scagr7-2c_rlfddd_graph.gif,',
}
