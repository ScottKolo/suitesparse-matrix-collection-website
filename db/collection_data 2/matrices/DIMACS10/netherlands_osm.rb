{
    ...
    group: 'DIMACS10',
    description: 'DIMACS10 set: streets/netherlands_osm',
...
',
    aux_fields: 'coord: full 2216688-by-2
',    image_files: 'netherlands_osm.png,netherlands_osm_gplot.png,netherlands_osm_graph.gif,',
}
