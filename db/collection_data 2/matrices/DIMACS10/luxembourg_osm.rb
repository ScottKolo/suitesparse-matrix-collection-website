{
    ...
    name: 'luxembourg_osm',
    group: 'DIMACS10',
    description: 'DIMACS10 set: streets/luxembourg_osm',
...
',
    aux_fields: 'coord: full 114599-by-2
',    image_files: 'luxembourg_osm.png,luxembourg_osm_gplot.png,luxembourg_osm_graph.gif,',
}
