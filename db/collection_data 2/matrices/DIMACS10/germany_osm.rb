{
    ...
    name: 'germany_osm',
    group: 'DIMACS10',
    description: 'DIMACS10 set: streets/germany_osm',
...
',
    aux_fields: 'coord: full 11548845-by-2
',    image_files: 'germany_osm.png,germany_osm_gplot.png,germany_osm_graph.gif,',
}
