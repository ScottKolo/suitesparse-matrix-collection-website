{
    ...
    name: 'lowThrust_1',
    group: 'VDOL',
    description: 'lowThrust optimal control problem (matrix 1 of 13)',
    ...
    num_strongly_connected_components: '27',
...
',
    b_field: 'full 584-by-1
',
    aux_fields: 'rowname: full 584-by-79
mapping: full 584-by-1
',    image_files: 'lowThrust_1.png,lowThrust_10.png,lowThrust_11.png,lowThrust_12.png,lowThrust_13.png,lowThrust_1_dmperm.png,lowThrust_1_scc.png,lowThrust_10_graph.gif,lowThrust_11_graph.gif,lowThrust_12_graph.gif,lowThrust_13_graph.gif,lowThrust_1_graph.gif,',
}
