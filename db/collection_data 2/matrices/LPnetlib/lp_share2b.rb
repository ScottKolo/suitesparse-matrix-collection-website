{
    ...
    name: 'lp_share2b',
    group: 'LPnetlib',
    description: 'Netlib LP problem share2b: minimize c\'*x, where Ax=b, lo<=x<=hi',
    author: 'M. Saunders',
    editor: 'D. Gay',
    date: '',
...
',
    b_field: 'full 96-by-1
',
    aux_fields: 'c: full 162-by-1
lo: full 162-by-1
hi: full 162-by-1
z0: full 1-by-1
',    norm: '5.867492e+02',
    min_singular_value: '4.974470e-02',
    condition_number: '1.179521e+04',
    svd_rank: '96',
    sprank_minus_rank: '0',
    null_space_dimension: '0',
    full_numerical_rank: 'yes',
    image_files: 'lp_share2b.png,lp_share2b_svd.png,lp_share2b_graph.gif,',
}
