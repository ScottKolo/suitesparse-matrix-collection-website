{
    ...
    name: 'lp_qap15',
    group: 'LPnetlib',
    description: 'Netlib LP problem qap15: minimize c\'*x, where Ax=b, lo<=x<=hi',
    author: 'T. Johnson',
...
z0: full 1-by-1
',    norm: '9.829069e+00',
    min_singular_value: '7.041975e-18',
    condition_number: '1395783019139904768',
    svd_rank: '5698',
    sprank_minus_rank: '632',
    null_space_dimension: '632',
    full_numerical_rank: 'no',
    svd_gap: '250746877187146.312500',
    image_files: 'lp_qap15.png,lp_qap15_svd.png,lp_qap15_graph.gif,',
}
