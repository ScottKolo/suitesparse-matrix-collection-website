{
    ...
    name: 'lp_bandm',
    group: 'LPnetlib',
    description: 'Netlib LP problem bandm: minimize c\'*x, where Ax=b, lo<=x<=hi',
    author: 'M. Saunders',
    editor: 'D. Gay',
    date: '',
...
z0: full 1-by-1
',    norm: '4.158591e+02',
    min_singular_value: '1.098128e-01',
    condition_number: '3.786981e+03',
    svd_rank: '305',
    sprank_minus_rank: '0',
    null_space_dimension: '0',
    full_numerical_rank: 'yes',
    image_files: 'lp_bandm.png,lp_bandm_dmperm.png,lp_bandm_svd.png,lp_bandm_graph.gif,',
}
