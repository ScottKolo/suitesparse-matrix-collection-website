{
    ...
    name: 'lp_qap12',
    group: 'LPnetlib',
    description: 'Netlib LP problem qap12: minimize c\'*x, where Ax=b, lo<=x<=hi',
    author: 'T. Johnson',
...
z0: full 1-by-1
',    norm: '8.725180e+00',
    min_singular_value: '7.239838e-19',
    condition_number: '1.205162e+19',
    svd_rank: '2794',
    sprank_minus_rank: '398',
    null_space_dimension: '398',
    full_numerical_rank: 'no',
    svd_gap: '272779276594730.937500',
    image_files: 'lp_qap12.png,lp_qap12_svd.png,lp_qap12_graph.gif,',
}
