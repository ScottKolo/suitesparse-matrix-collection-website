{
    ...
    name: 'crashbasis',
    group: 'QLi',
    description: 'MCP; mixed complementarity optimization problem; similar to QLi/majorbasis',
...
',
    image_files: 'crashbasis.png,crashbasis_APlusAT_graph.gif,crashbasis_graph.gif,',
}
