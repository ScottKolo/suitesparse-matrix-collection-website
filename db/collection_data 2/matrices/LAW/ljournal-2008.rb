{
    ...
    name: 'ljournal-2008',
    group: 'LAW',
    description: 'LiveJournal social netowrk',
    ...
    num_strongly_connected_components: '1119171',
    pattern_symmetry: '0.730',
    numeric_symmetry: '0.730',
    rb_type: 'binary',
...
see http://law.di.unimi.it/webdata/ljournal-2008                         
',
    image_files: 'ljournal-2008.png,ljournal-2008_scc.png,ljournal-2008_APlusAT_graph.gif,ljournal-2008_graph.gif,',
}
