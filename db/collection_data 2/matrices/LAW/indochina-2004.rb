{
    ...
    name: 'indochina-2004',
    group: 'LAW',
    description: '2004 Indochina web crawl',
    ...
    num_strongly_connected_components: '1749052',
    pattern_symmetry: '0.424',
    numeric_symmetry: '0.424',
    rb_type: 'binary',
...
',
    image_files: 'indochina-2004.png,indochina-2004_scc.png,indochina-2004_APlusAT_graph.gif,indochina-2004_graph.gif,',
}
