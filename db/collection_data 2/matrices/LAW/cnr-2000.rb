{
    ...
    name: 'cnr-2000',
    group: 'LAW',
    description: 'small web crawl of Italian CNR domain',
    ...
    num_strongly_connected_components: '100977',
    pattern_symmetry: '0.249',
    numeric_symmetry: '0.249',
    rb_type: 'binary',
...
',
    image_files: 'cnr-2000.png,cnr-2000_scc.png,cnr-2000_APlusAT_graph.gif,cnr-2000_graph.gif,',
}
