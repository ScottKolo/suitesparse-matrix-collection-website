{
    ...
    name: 'Spielman_k500',
    group: 'FlowIPM22',
    description: 'max flow Chimera graph: FlowIPM22/Spielman_k500',
...
Problem set name:        Spielman_k500                                   
                                                                         
The primary matrix is the first matrix in the set.                       
Original matrix names in this sequence:                                  
                                                                         
    1: ipmMat/spielman.k500.low0.25.up1.0e-6.i1.mm                       
    2: ipmMat/spielman.k500.low0.25.up1.0e-6.i2.mm                       
    3: ipmMat/spielman.k500.low0.25.up1.0e-6.i3.mm                       
    4: ipmMat/spielman.k500.low0.25.up1.0e-6.i4.mm                       
    5: ipmMat/spielman.k500.low0.25.up1.0e-6.i5.mm                       
    6: ipmMat/spielman.k500.low0.25.up1.0e-6.i6.mm                       
    7: ipmMat/spielman.k500.low0.25.up1.0e-6.i7.mm                       
    8: ipmMat/spielman.k500.low0.25.up1.0e-6.i8.mm                       
    9: ipmMat/spielman.k500.low0.25.up1.0e-6.i9.mm                       
   10: ipmMat/spielman.k500.low0.25.up1.0e-6.i10.mm                      
',
