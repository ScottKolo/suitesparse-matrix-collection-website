{
    matrix_id: '2863',
    name: 'dataset18mfeatmorphological_10NN',
    group: 'ML_Graph',
    description: 'machine learning graph: dataset18mfeatmorphological_10NN',
...
Graph: dataset18mfeatmorphological_10NN Classes: 10                    
',
    aux_fields: 'label: full 2000-by-1
',    image_files: '',
}
