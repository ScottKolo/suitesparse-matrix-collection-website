{
    matrix_id: '2868',
    name: 'Fashion_MNIST_norm_10NN',
    group: 'ML_Graph',
    description: 'machine learning graph: Fashion_MNIST_norm_10NN',
...
Graph: Fashion_MNIST_norm_10NN Classes: 10                             
',
    aux_fields: 'label: full 10000-by-1
',    image_files: '',
}
