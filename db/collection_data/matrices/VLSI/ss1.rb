{
    ...
    name: 'ss1',
    group: 'VLSI',
    description: 'VLSI: semiconductor device and process simulation',
    author: 'Anonymous',
    editor: 'T. Davis',
    date: '2018',
    kind: 'semiconductor process problem',
    problem_2D_or_3D: '1',
    num_rows: '205282',
    num_cols: '205282',
    nonzeros: '845089',
    num_explicit_zeros: '0',
    num_strongly_connected_components: '95977',
    num_dmperm_blocks: '95977',
    structural_full_rank: 'true',
    structural_rank: '205282',
    pattern_symmetry: '0.994',
    numeric_symmetry: '0.042',
    rb_type: 'real',
    structure: 'unsymmetric',
    cholesky_candidate: 'no',
    positive_definite: 'no',
    notes: 'VLSI: semiconductor device and process simulation                            
...
',
    image_files: 'ss1.png,ss1_dmperm.png,',
}
